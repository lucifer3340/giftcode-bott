...
API_TOKEN = '8152859348:AAHUFefWp-3rCAUuwUEV4eymSIIK65DFP9Y'  # 👈 Apna BotFather wala token yahan daalo

bot = telebot.TeleBot(API_TOKEN)

# ✅ Yahan apne daily giftcodes aur links dal do:
giftcodes = {
    'TASHAN WIN': {
